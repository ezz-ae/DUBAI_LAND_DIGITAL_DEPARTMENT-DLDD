    ...
    <div className="flex-1 overflow-hidden bg-background/50">
        <ScrollArea className="h-full">
            <div className="max-w-7xl mx-auto w-full p-6 md:p-8 space-y-8">
                ...
                <SimulationScenario 
                    title="Scenario 3: Emaar's Ultra-Luxury Villa (Off-Plan)"
                    context={
                        <>
                ...
                <SimulationScenario 
                    title="Scenario 4: Investor Acquires Full Stake & Exits Pool"
                    context={
                        <>
                ...
                <div className="prose dark:prose-invert max-w-full text-center py-8">
                    <Separator />
                    <h3 className="mt-8">Conclusion for Simulations: DLDCHAIN™'s Versatility and Robustness</h3>
                    <p>These real-world simulations powerfully demonstrate DLDCHAIN™'s unparalleled ability to navigate the complexities of diverse real estate assets and ownership structures. From an individual's apartment to a large-scale mortgaged villa, a high-value off-plan development, and the sophisticated process of an institutional investor acquiring full stake and exiting a tokenized pool, DLDCHAIN™ consistently provides rapid liquidity, unwavering trust, automated precision, and full lifecycle management for every asset.</p>
                </div>
