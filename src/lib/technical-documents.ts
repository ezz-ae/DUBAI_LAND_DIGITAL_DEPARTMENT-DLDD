                        ...
                        { 
                            ...
                            content: [
                                ...
                                { type: 'paragraph', text: '<strong>Mockup Plan:</strong>'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Tools:</strong> Use Figma or Adobe XD to design responsive interfaces for web, mobile (iOS/Android), and API-driven developer dashboards.',
                                        '<strong>Features:</strong><ul><li><strong>Role-Based Dashboard:</strong> Dynamic UI adjusting to user roles (e.g., investor sees DXBTOKEN portfolio, broker sees Mashroi tasks).</li><li><strong>DLD-AED Transactions:</strong> Mock fiat-to-DLD-AED conversion, deposit/withdrawal flows, and tiered KYC limits.</li><li><strong>DXBTOKEN Management:</strong> Visualize token portfolios, spot/limit order placements, and fractional trading.</li><li><strong>Security:</strong> Mock OTP-based login, biometric verification, and UAE Pass integration.</li></ul>',
                                        '<strong>Deliverables:</strong><ul><li>Wireframes for mobile and web interfaces.</li><li>Interactive prototype simulating wallet interactions (e.g., token purchase, contract signing).</li><li>API mockups for developer integration (e.g., REST endpoints for wallet functions).</li></ul>'
                                    ]
                                },
                                ...
                                { type: 'paragraph', text: '<strong>Mockup Plan:</strong>'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Tools:</strong> Use Dialogflow or Rasa for conversational UI prototyping, integrated with a web-based frontend (React) and mobile app (Flutter).',
                                        '<strong>Features:</strong><ul><li><strong>Natural Language Input:</strong> Simulate Arabic/English input for contract drafting (e.g., “Draft a lease for 12 months at AED 100,000”).</li><li><strong>Contract Visualization:</strong> Display EBRAM syntax and Python code translations, with explanations in plain language.</li><li><strong>Context-Aware Suggestions:</strong> Mock AI-driven prompts for legal clauses based on user role and transaction type.</li><li><strong>Multi-Channel Access:</strong> Prototype mobile chat, web terminal, and voice (Arabic) interfaces.</li></ul>',
                                        '<strong>Deliverables:</strong><ul><li>Conversational flow diagrams for EBRAMGPT interactions.</li><li>Prototype of AI-driven contract drafting and clause explanation.</li><li>Mock API responses for real-time data integration (e.g., Ejari triggers).</li></ul>'
                                    ]
                                },
                                ...
                                { type: 'paragraph', text: '<strong>Mockup Plan:</strong>'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Tools:</strong> Use WordPress or Bubble for rapid prototyping of the web platform, with Firebase for real-time data simulation.',
                                        '<strong>Features:</strong><ul><li><strong>Broker Dashboard:</strong> Mock licensing status, CPD progress, and job matches.</li><li><strong>Smart Visa Workflow:</strong> Simulate visa issuance/renewal tied to performance metrics.</li><li><strong>Gamified Rewards:</strong> Visualize reward points, visa extensions, and mentorship missions.</li><li><strong>Developer Integration:</strong> Mock daily project updates (unit availability, sales status).</li></ul>',
                                        '<strong>Deliverables:</strong><ul><li>Wireframes for broker and developer dashboards.</li><li>Prototype of smart quiz engine and job-matching algorithm.</li><li>Mock API for GDRFA visa integration.</li></ul>'
                                    ]
                                },
                                ...
                                { type: 'paragraph', text: '<strong>Mockup Plan:</strong>'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Tools:</strong> Use Sketch or Figma for UI design, with Node.js for simulating backend APIs.',
                                        '<strong>Features:</strong><ul><li><strong>Token Trading:</strong> Mock spot buy/sell, limit orders, and auto-split sell interfaces.</li><li><strong>Liquidity Pool:</strong> Visualize MAKE events, escrow deposits, and token allocation (40% owner, 55% public, etc.).</li><li><strong>Market Analytics:</strong> Simulate live dashboards for token prices, market trends, and MPT events.</li></ul>',
                                        '<strong>Deliverables:</strong><ul><li>Prototype of trading interface with real-time price updates.</li><li>Mock data feeds for EBRAM’s AI market-making logic.</li></ul>'
                                    ]
                                }
                            ] 
                        },
                        { 
                            ...
                            content: [
                                { type: 'heading', text: 'a. Technology Stack'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Blockchain:</strong> Hyperledger Fabric (v2.5 or later) for permissioned, modular architecture.',
                                        '<strong>Smart Contract Language:</strong><ul><li><strong>EBRAM Layer:</strong> Custom DSL (Domain-Specific Language) for legal logic, implemented as a high-level abstraction.</li><li><strong>Python Layer:</strong> Chaincode in Python for computational backend, handling blockchain interactions and API calls.</li></ul>',
                                        '<strong>Database:</strong> CouchDB for state database, supporting rich queries for property data.',
                                        '<strong>APIs:</strong> RESTful APIs using Node.js/Express for integration with external systems (Ejari, Milka, etc.).',
                                        '<strong>AI Integration:</strong> TensorFlow or PyTorch for EBRAMGPT’s natural language processing and contract generation.'
                                    ]
                                },
                                { type: 'heading', text: 'b. EBRAM Smart Contract Structure'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Contract Tree:</strong><ul><li><strong>Root:</strong> Land Number (unique identifier for land parcels).</li><li><strong>Nodes:</strong> Zone → Project → Building → Unit (non-dividable ownerable asset).</li><li><strong>Implementation:</strong> Use Fabric’s chaincode to define hierarchical data structures, with each node storing metadata (e.g., legal status, ownership, EBRAMINT status).</li></ul>',
                                        '<strong>Core Constructs:</strong><ul><li><strong>Conditions:</strong> IF/THEN/ELSE/UNLESS logic (e.g., IF payment.received THEN transfer.title).</li><li><strong>Roles:</strong> Define participants (e.g., Owner, Tenant, DLD) with role-based access control.</li><li><strong>Actions:</strong> Programmable operations (e.g., transfer.title, issue.fine).</li><li><strong>Triggers:</strong> Event-based (e.g., lease.startDate + 3 days && noKeyPickup → auto-cancel).</li></ul>',
                                        '<strong>EBRAMINT Process:</strong><ul><li><strong>Step 1:</strong> Validate property data via Ejari/Milka oracles.</li><li><strong>Step 2:</strong> Assign City Digital ID (CDID) using SHA-256 hashing.</li><li><strong>Step 3:</strong> Publish contract to Fabric ledger with multi-signature approval (DLD, MAKE Officer).</li><li><strong>Step 4:</strong> Record EBRAMINT event, marking the asset as tokenized and immutable.</li></ul>'
                                    ]
                                },
                                ...
                                { type: 'heading', text: 'd. Development Workflow'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Design Phase:</strong><ul><li>Define EBRAM syntax and grammar for legal clauses.</li><li>Map Dubai’s real estate laws (e.g., Ejari, RERA) to EBRAM constructs.</li></ul>',
                                        '<strong>Coding Phase:</strong><ul><li>Develop chaincode in Python for core logic.</li><li>Implement EBRAM DSL as a parser that translates legal clauses to Python.</li></ul>',
                                        '<strong>Testing Phase:</strong><ul><li>Use Hyperledger Fabric’s test network to simulate contract execution.</li><li>Test edge cases (e.g., breach conditions, multi-signature failures).</li></ul>',
                                        '<strong>Integration Phase:</strong><ul><li>Connect EBRAM to Ejari/Milka via secure APIs.</li><li>Validate triggers with real-world data (e.g., DEWA utility status).</li></ul>'
                                    ]
                                }
                            ] 
                        },
                        { 
                            ...
                            content: [
                                ...
                                { type: 'paragraph', text: '<strong>Objective:</strong> Build core infrastructure and governance framework.'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Tasks:</strong><ul><li><strong>Blockchain Setup:</strong> Deploy Hyperledger Fabric network with private channels for DLD, VARA, and CBUAE.</li><li><strong>DLD-AED Stablecoin:</strong> Develop smart contract for DLD-AED issuance, pegged 1:1 to AED, and integrate with CBUAE for reserve audits and AML/KYC compliance.</li><li><strong>Governance:</strong> Form Governing Council with DLD as Chair, VARA as Vice-Chair, and define endorsement policies for chaincode deployment.</li><li><strong>Security:</strong> Implement zero-trust architecture with UAE Pass integration, and develop OTP and biometric authentication for UNIVESTOR Wallet.</li></ul>',
                                        '<strong>Deliverables:</strong><ul><li>Hyperledger Fabric network with initial chaincode.</li><li>DLD-AED wallet prototype with KYC tiers.</li><li>Governance charter for DLDCHAIN Council.</li></ul>'
                                    ]
                                },
                                ...
                                { type: 'paragraph', text: '<strong>Objective:</strong> Pilot EBRAM for residential leases.'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Tasks:</strong><ul><li><strong>EBRAM Development:</strong> Build EBRAM DSL and Python chaincode for lease contracts, and integrate with Ejari for genesis event triggers.</li><li><strong>EBRAMGPT:</strong> Train NLP model for Arabic/English contract drafting, and develop API for real-time data integration (Ejari, Milka, DEWA).</li><li><strong>Testing:</strong> Conduct security audits for chaincode vulnerabilities, and simulate lease lifecycle (drafting, signing, execution, renewal).</li><li><strong>Pilot:</strong> Deploy pilot for 1,000 residential leases in Dubai, and collect feedback from landlords, tenants, and brokers.</li></ul>',
                                        '<strong>Deliverables:</strong><ul><li>EBRAM smart contract suite for residential leases.</li><li>EBRAMGPT prototype with conversational UI.</li><li>Pilot report with performance metrics and user feedback.</li></ul>'
                                    ]
                                },
                                ...
                                { type: 'paragraph', text: '<strong>Objective:</strong> Expand EBRAM to all property types and enable DXBTOKEN trading.'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Tasks:</strong><ul><li><strong>EBRAM Expansion:</strong> Extend EBRAM to commercial, retail, and fractional ownership contracts, and integrate with Trakheesi for advertising compliance.</li><li><strong>DXBTOKEN Marketplace:</strong> Develop chaincode for spot/limit orders and pool takeovers, and implement EBRAM’s AI market-making logic for price stability.</li><li><strong>Secondary Market:</strong> Partner with VARA-licensed exchange for DXBTOKEN trading, and enable auto-split sell and pre-pledge buy mechanisms.</li><li><strong>Mashroi Rollout:</strong> Deploy broker licensing and CPD platform, and integrate with GDRFA for smart visa issuance.</li></ul>',
                                        '<strong>Deliverables:</strong><ul><li>EBRAM contracts for all property types.</li><li>DXBTOKEN marketplace with live trading dashboard.</li><li>Mashroi platform with 10,000 registered brokers.</li></ul>'
                                    ]
                                },
                        ...
                        { 
                            ...
                            content: [
                                ...
                                { type: 'heading', text: 'b. EBRAM (Smart Contract Engine)' },
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Role:</strong> Domain-specific language (DSL) for real estate governance, encoding legal clauses into executable smart contracts.',
                                        '<strong>Subcomponents:</strong><ul><li><strong>EBRAM DSL:</strong> Syntax with legal constructs (IF/THEN/ELSE, roles, actions, triggers), parsed into Python chaincode.</li><li><strong>Python Chaincode:</strong> Handles blockchain interactions, API calls, and event triggers using Fabric SDK.</li><li><strong>EBRAM Contract Tree:</strong> Hierarchical structure from Land Number to Unit, with each unit being a non-dividable “ownerable asset” with a unique CDID.</li><li><strong>EBRAMINT Process:</strong> Multi-step process to validate, assign CDID, multi-sign, and publish contracts to the ledger.</li><li><strong>Integrations:</strong> With Ejari, Milka, Trakheesi, and DEWA for real-time data validation.</li></ul>'
                                    ]
                                },
                                { type: 'heading', text: 'c. EBRAMGPT (AI Legal Assistant)' },
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Role:</strong> AI-powered interface for natural language interaction with EBRAM contracts.',
                                        '<strong>Technical Specifications:</strong><ul><li><strong>NLP Framework:</strong> TensorFlow/PyTorch with fine-tuned BERT for Arabic/English legal text.</li><li><strong>Functionalities:</strong> Bi-directional language conversion, context-aware drafting, and risk flagging.</li><li><strong>Interfaces:</strong> Mobile (UNIVESTOR Wallet), Web (DLD dashboard), Voice, and Developer API.</li></ul>'
                                    ]
                                },
                                { type: 'heading', text: 'd. DLD-AED (Stablecoin)' },
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Role:</strong> Fiat-pegged digital currency (1:1 with AED) for all DLDCHAIN transactions.',
                                        '<strong>Smart Contract:</strong> Fabric chaincode for issuance, transfer, and redemption, backed by audited reserves.'
                                    ]
                                },
                                { type: 'heading', text: 'e. DXBTOKENS (Tokenized Assets)' },
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Role:</strong> Represents fractional ownership of real estate assets.',
                                        '<strong>Trading:</strong> Spot/limit orders, auto-split, pre-pledge, and pool takeover mechanisms on the DLDCHAIN Marketplace, with liquidity ensured by MAKE.'
                                    ]
                                },
                                { type: 'heading', text: 'f. Mashroi (Professional Hub)' },
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Role:</strong> Regulates brokers, manages education, and facilitates job matching.',
                                        '<strong>Features:</strong> Smart Licensing, CPD tracking, Visa Gateway (GDRFA integration), AI-driven job matching, gamification, and real-time developer updates.'
                                    ]
                                },
                                { type: 'heading', text: 'g. UNIVESTOR Wallet' },
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Role:</strong> Unified interface for DLD-AED, DXBTOKENS, and EBRAM contracts.',
                                        '<strong>Security:</strong> OTP/biometric login via UAE Pass, zero-trust architecture, and private data collections for sensitive transactions.'
                                    ]
                                }
                            ]
                        },
                    ...
                    articles: [
                        { 
                            ...
                            content: [
                                ...
                                {
                                    type: 'list', items: [
                                        '<strong>Auditable Scores & Real-Time Tracking:</strong><ul><li>Automated Data Collection: Meticulously tracks payment history, contractual breaches, regulatory violations, and dispute outcomes.</li><li>Objective Scoring: Translates data into auditable reputation scores based on verifiable on-chain data.</li></ul>',
                                        '<strong>Influencing Future Contractual Terms & Opportunities:</strong><ul><li>Dynamic Contract Adjustments: Reputation scores influence future contractual terms (e.g., preferential rates for good tenants).</li><li>Risk Mitigation: Provides a powerful risk mitigation tool for all parties.</li><li>Meritocratic Access: Reinforces Mashroi\'s "opportunity is for the deserving" philosophy.</li></ul>',
                                        '<strong>Proactive Market Integrity:</strong><ul><li>Early Warning System: Proactively flags suspicious activities or emerging risks.</li><li>Building Trust: Fosters a culture of accountability where good behavior is rewarded.</li></ul>'
                                    ]
                                },
                    ...
                    articles: [
                        {
                            ...
                            content: [
                                ...
                                { type: 'subheading', text: 'How a Mortgaged Property is Tokenized on DLDCHAIN:' },
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Initiation by Owner via Mashroi-Qualified Broker:</strong><ul><li>The property owner initiates the process through a RERA-accredited broker qualified by Mashroi.</li><li>The broker gathers initial documents, and Ebram performs the preliminary eligibility check.</li></ul>',
                                        '<strong>Ebram\'s Intelligent Legal Due Diligence & Mortgage Binding:</strong><ul><li>Ebram conducts meticulous legal due diligence, verifying the title deed and assessing the existing mortgage lien.</li><li>The mortgage status and obligations become a transparent attribute of the tokenized asset on the ledger.</li><li>The system facilitates automated lender consent and notification.</li></ul>',
                                        '<strong>Liquidity Provision via MAKE System (The Breakthrough Innovation):</strong><ul><li>An approved MAKE Officer deposits the full appraised market value into an on-chain escrow managed by Ebram.</li><li>This liquidity is used to either pay off the mortgage entirely or to re-collateralize the lender\'s interest on-chain.</li><li>Ebram issues a binding escrowship certificate, guaranteeing the financial backing.</li></ul>',
                                        '<strong>DXBTOKENS Minting & Instant Trading:</strong><ul><li>Once legal and financial conditions are secured, DXBTOKENS are minted.</li><li>These tokens are immediately tradable on the DLDCHAIN marketplace.</li></ul>'
                                    ]
                                },
                    ...
                    articles: [
                         {
                            ...
                            content: [
                                ...
                                { type: 'subheading', text: 'How Off-Plan Property is Tokenized on DLDCHAIN:'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Developer-Initiated Tokenization:</strong><ul><li>Only DLD-approved developers can initiate tokenization for their off-plan projects.</li></ul>',
                                        '<strong>Ebram\'s Early Legal Vetting & Milestone Integration:</strong><ul><li>Ebram has comprehensive knowledge of the project\'s status, progress, and permits.</li><li>The smart contract encodes key development milestones and payment schedules.</li><li>Ebram\'s pricing mechanism dynamically adjusts token value as the handover date approaches.</li></ul>',
                                        '<strong>DXBTOKENS Minting (Future Value Today):</strong><ul><li>DXBTOKENS are minted and available for trading before physical completion.</li><li>Each token represents a quantifiable share (e.g., 1 Token = 1 sq. ft.) of the projected final value.</li></ul>',
                                        '<strong>Liquidity Provision via MAKE System (Pre-Funding the Future):</strong><ul><li>The MAKE system provides early liquidity to developers.</li><li>An approved MAKE Officer deposits the appraised value into an escrow, allowing the developer to receive immediate cash.</li><li>This ensures even off-plan tokens are backed by 100% AED liquidity, instilling investor confidence.</li></ul>'
                                    ]
                                },
                                { type: 'subheading', text: 'Impact: Accelerated Development & Expanded Investment Access:'},
                                {
                                    ...
                                    items: [
                                        ...
                                        '<strong>For Investors:</strong> Offers a transparent and accessible way to invest in off-plan properties with the added benefit of liquidity.',
                                        '<strong>Reduced Risk:</strong> The legal binding of the contract to Ebram and liquidity backing by MAKE provide layers of security often lacking in traditional off-plan purchases.'
                                    ]
                                },
                    ...
                    articles: [
                        {
                            ...
                            content: [
                                ...
                                { type: 'list', items: [
                                    '<strong>1. The Property Owner (Seller): "Win Big"</strong><ul><li>Gets instant liquidity (60% cash) and retains upside (40% DXBTOKENS). They are fully paid almost instantly while benefiting from potential growth.</li></ul>',
                                    '<strong>2. The Liquidity Provider (MAKE Officer / Investor): "Guaranteed & Market Gains"</strong><ul><li>Receives a guaranteed fixed profit (2% of property price) plus potential market gains from tokens in the fund.</li></ul>',
                                    '<strong>3. The DXBTOKEN Buyer/Investor (on the Marketplace): "Accessible & Liquid Ownership"</strong><ul><li>Gains access to fractional, affordable ownership with instant liquidity and transparent valuation.</li></ul>',
                                    '<strong>4. The Real Estate Broker (via Mashroi): "Enhanced Earnings & Professional Growth"</strong><ul><li>Unlocks new revenue streams from tokenization and trading, with increased transaction velocity and merit-based opportunities.</li></ul>',
                                    '<strong>5. The Dubai Land Department (DLD) & The Government: "Strategic Oversight & Economic Growth"</strong><ul><li>Gains full transparency, new revenue channels, and enhanced market stability, boosting GDP and solidifying Dubai\'s leadership.</li></ul>'
                                ]},
                    ...
                    articles: [
                        {
                            ...
                            content: [
                                ...
                                { type: 'list', items: [
                                    '<strong>Facilitating Primary Tokenization:</strong> Brokers guide owners through "Ebram Submissions," ensuring legal eligibility and earning commissions on successful tokenizations.',
                                    '<strong>Brokering Token Sales:</strong> Brokers operate on the digital marketplace, using "client token platforms" (kiosks on the DLDCHAIN system) to display and sell DXBTOKENS, earning commissions on faster, lower-cost digital transactions.',
                                    '<strong>Specializing in Off-Plan Token Sales:</strong> Brokers partner with developers to market and sell newly minted off-plan tokens, benefiting from quicker commission payouts due to the MAKE system\'s instant liquidity.',
                                    '<strong>Leveraging Liquidity Incentives:</strong> Brokers use their knowledge of the MAKE system to guide clients on how tokenization enables rapid liquidity, contributing to a more active and profitable ecosystem.'
                                ]},
                                { type: 'heading', text: 'Learn & Earn in Mashroi: Elevating Expertise and Income:'},
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Knowledge as Currency:</strong> Broker expertise in tokenization and smart contracts directly impacts their earning potential.',
                                        '<strong>Performance-Based Access:</strong> Only brokers with sufficient training in Mashroi can access high-value tokenization contracts in Ebram, ensuring quality and trust.',
                                        '<strong>Job Matching & Career Progression:</strong> Mashroi\'s AI matches brokers with hiring opportunities based on verified skills, promoting meritocratic growth.',
                                        '<strong>Gamified Rewards & Visa Facilitation:</strong> The system offers rewards and streamlines visa processes, enhancing career stability.'
                                    ]
                                },
                    ...
                    articles: [
                        {
                            ...
                            content: [
                                ...
                                { type: 'subheading', text: 'Why "Connecting, Not Replacing" is Crucial:' },
                                {
                                    type: 'list',
                                    items: [
                                        '<strong>Minimizing Disruption & Resistance:</strong> Integrates with familiar platforms to ensure a smooth transition and leverage existing infrastructure, avoiding the costs and resistance of a full replacement.',
                                        '<strong>Enhancing Data Reliability:</strong> Transforms existing DLD systems (Ejari, Milka, Trakheesi) into "Smart Verification Oracles," feeding verified, real-time data into the blockchain to eliminate discrepancies.',
                                        '<strong>Fostering Inter-Agency Collaboration:</strong> Creates a unified digital ecosystem through extensive API integration with various governmental entities, enabling seamless information flow and coordinated governance.',
                                        '<strong>Maintaining Legal Continuity:</strong> Executes, rather than disrupts, existing legal statutes. Ebram translates established property laws into executable code, ensuring digital operations are legally compliant.',
                                        '<strong>Accelerating Digital Transformation:</strong> Enables a phased, incremental approach to digital transformation, building upon existing strengths for a sustainable path to a fully digital economy.'
                                    ]
                                },
